    ...
    <section class="container registration">
      <div class="row">
        <div class="col-12 col-md-8 col-xl-7 m-auto">
            <? if (!isset($_POST['goToStepTwo']) && !isset($_POST['register'])) : ?>
              <h1>Register your account</h1>

              <!-- step1 -->
              <form class="needs-validation" action="index.php" method="POST" name="registrationStepOne" id="step1">
                  ...
                  <div class="registerPart">
                    ...
                    <div class="form-group">
                      <label for="secondName">CUSTOMER LAST NAME*</label>
                      <input type="text" class="form-control" id="secondName" name="lastName" required>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-warning ml-auto next" name="goToStepTwo">Next</div>              
                  </div> >
              </form>  
              <? endif ?>
              <!-- step1 end -->
              ...
              <!-- step2 -->
              <? if (isset($_POST['goToStepTwo']) && !isset($_POST['register'])) : ?>              
              <form class="needs-validation" action="index.php" method="POST" name="registrationStepTwo" id="step2">  
                  <h2>Tell us about your home</h2>
                  <div class="registerPart">  
                    <div class="form-group row">
                      <label class="col-12">Do you have solar panels in your home?</label>
                      <div class="col-6">
                    ...
                    <div class="form-group row">
                      <label class="col-12">Do you have electricity through PG&E?</label>
                      <div class="col-6">
                    ...
                    <div class="form-group row">
                      <label class="col-12">Have you participated in a PG&E rebates program previously?</label>
                      <div class="col-6">
                    ...
                    <div class="form-group row">
                      <label class="col-12">Have you lived in your home for at least 14 months?</label>
                      <div class="col-6">
            ...
            <? if (isset($_POST['register'])) : ?> 
              ...
              <?
                foreach ($_SESSION as $key => $value) {
                  if ($key!='goToStepTwo' && $key!='register' && $key!='csrf') {
                    echo $key.' : '.$value.'<br>';
                  }
                }
                session_destroy();
